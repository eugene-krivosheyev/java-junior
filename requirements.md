...
## Аутентификация
### User Story
Я, как пользователь, хочу доказать системе, что я это я, чтобы все участники чата ассоциировали все мои сообщения со мной.
### Acceptance Test
#### Given
- Запущены клиентское и серверное приложения.
#### When
...
- Я ввожу пароль.
#### Then
- Все текущие сообщения от меня снабжаются информацией о моем нике.
